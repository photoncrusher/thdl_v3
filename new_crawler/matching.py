...
def transform(text):
    ...
    link= ["link", "url"]
    feature_list = []
    feature_list=[link,pin,color,status,name,resolution,screensize,screentech,cpu,rom,ram,gpu,size,rear_cam,front_cam,sim,tech,wifi,bluetooth,weigth,os,port,price]
...
def convert(data):
    schema = schemaItems()
    feature_list =  "link,color,status,name,resolution,screensize,screentech,cpu,rom,ram,gpu,size,rear_cam,front_cam,sim,tech,wifi,bluetooth,weigth,os,port,price".split(",")
    l = []
    for col in data:
        l.append(col)
    l = set(l)
