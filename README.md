...
### Quan trọng:
- [x] <strike> Crawl ngay 1 bản mẫu (đầy đủ) của iphone, ipad và applewatch để data matching.
...
- [x] <strike> Ông @QuangPhuc kiểm tra lại cái crawler xem, khá nhiều sản phẩm ở 1 trang của ông bị thiếu trường name ! (cái này thiếu name thì match ko nổi).
- [x] <strike> chuyển các trường nan về thành string 'unknow' trước khi đẩy vào elastic search
- [x] <strike> Ông Quân check ngay cho ae cái kibana nhé. Tôi sẽ không đụng đến phần đấy đâu. file csv của ông là data.csv
